...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"main.fb96eab9.js":[function(require,module,exports) {
var define;
...
parcelRequire = function (modules, cache, entry, globalName) {
  ...
  return newRequire;
    ...
    var localDataObject = JSON.parse(localData); //字符串变成对象
    ...
    var hashMap = localDataObject || [{ logo: 'A', url: 'https://www.acfun.cn' }, { logo: 'B', url: 'https://www.bilibili.com' }];
    var simplifyUrl = function simplifyUrl(url) {
      return url.replace('https://', '').replace('http://', '').replace('//', '').replace('www.', '').replace('/\/.*', '').replace('/\..*/', '').replace('.cn', '').replace('.com', '');
    };
...
//# sourceMappingURL=main.fb96eab9.map
},{}]